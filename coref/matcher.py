...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, coref_logits, res, gold_matrix):
        ...
        cluster_repeated = real_cluster_target[:,:-1].unsqueeze(1).repeat(1, new_coref_logits.shape[0], 1)
        coref_logits_repeated = new_coref_logits.unsqueeze(0).repeat(real_cluster_target.shape[0], 1, 1)
